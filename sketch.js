...
function setup() {
    ...
    var eCelular = /iPhone|iPad|iPod|Android/i.test
    (navigator.userAgent);
    ...
    b2.position(width / 3, height / 8);
    b2.size(50, 50);
    b2.mouseClicked(soltar2);

    b3 = createImg("cut_btn.png");
    b3.position(width / 4, height / 4);
    b3.size(50, 50);
    ...
    corda2 = new Rope(5, { x: width / 3, y: height / 8 });

    corda3 = new Rope(5, {x: width / 4, y: height / 4})
    ...
    coelho = createSprite(width / 3, height - 72, 50, 50);
